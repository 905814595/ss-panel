                            ...
                            <ul class="products-list product-list-in-box">
                                <li class="item">
                                    ...
                                    <div class="product-info">
                                        <a href="./share/{$node->id}" class="product-title">{$node->name} <span
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <ul class="nav nav-stacked">
                                        ...
                                        <li><a href="./share/{$node->id}">产生流量 <span
                                                        class="pull-right badge bg-green">{$node->getTrafficFromLogs()}</span></a>
                                        </li>
                                        <li><a href="./share/{$node->id}">Uptime: <span
